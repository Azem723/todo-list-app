...
const todolistSlice = createSlice({
  name: 'todolist',
  initialState: [
    { id: 12, text: 'aaa', isComplete: false },
    { id: 13, text: 'bbb', isComplete: false },
    { id: 14, text: 'ccc', isComplete: false },
    { id: 154, text: 'ddd', isComplete: false },
    { id: 1435, text: 'eee', isComplete: false },
    { id: 6345, text: 'fff', isComplete: false },
    { id: 234, text: 'ggg', isComplete: false },
    { id: 32, text: 'hhh', isComplete: false }
  ],
  reducers: {
