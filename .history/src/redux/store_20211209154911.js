...
import { todolistMiddleWarecopy } from './middleware/todolistMiddleWarecopy';
...
const store = configureStore({
  ...
  middleware: (getDefaultMiddleware) =>
    getDefaultMiddleware({
      thunk: {
        extraArgument: [todolistMiddleWare, todolistMiddleWarecopy]
      },
      serializableCheck: false
    }).concat(todolistMiddleWare, todolistMiddleWarecopy),
